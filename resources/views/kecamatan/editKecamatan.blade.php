...
<div class="min-h-full">
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Edit Kecamatan Page</h1>
      </div>
    </header>
    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <form action="{{ route('updateKecamatan', ['id' => $dataKec->id]) }}" method="post" class="max-w-md mx-auto">
            @csrf
            <div class="mb-4">
                <label for="kode_kec" class="block text-sm font-medium text-gray-700">Kode Kecamatan</label>
                <input type="text" name="kode_kec" id="kode_kec" value="{{ $dataKec->kode_kec }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="nama_kecamatan" class="block text-sm font-medium text-gray-700">Nama Kecamatan</label>
                <input type="text" name="nama_kecamatan" id="nama_kecamatan" value="{{ $dataKec->nama_kecamatan }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4 inline-block items-start justify-start">
              <label for="active_kec" class="block text-sm font-medium text-gray-700">Active</label>
              <input type="checkbox" name="active_kec" value="1" id="active_kec" {{ $dataKec->active_kec == 1 ? 'checked' :  '' }} class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
