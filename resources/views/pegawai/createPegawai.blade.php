...
<div class="min-h-full">
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Create Pegawai Page</h1>
      </div>
    </header>
    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <form action="{{ route('savePegawai') }}" method="POST" class="max-w-md mx-auto">
            {{ @csrf_field() }}
            <div class="mb-4">
                <label for="nama_pegawai" class="block text-sm font-medium text-gray-700">Nama Pegawai</label>
                <input type="text" name="nama_pegawai" id="nama_pegawai" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="tempat_lahir" class="block text-sm font-medium text-gray-700">Tempat Lahir</label>
                <input type="text" name="tempat_lahir" id="tempat_lahir" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="tgl_lahir" class="block text-sm font-medium text-gray-700">Tgl. Lahir</label>
                <input type="text" name="tgl_lahir" id="tgl_lahir" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="jenis_kelamin" class="block text-sm font-medium text-gray-700">Jenis Kelamin</label>
                <input type="text" name="jenis_kelamin" id="jenis_kelamin" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="agama" class="block text-sm font-medium text-gray-700">Agama</label>
                <input type="text" name="agama" id="agama" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="alamat" class="block text-sm font-medium text-gray-700">Alamat</label>
                <input type="text" name="alamat" id="alamat" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
              <div class="relative">
                  <select name="kelurahan_id" id="kelurahan_id" class="block text-sm font-medium text-gray-700">
                      <option disabled selected value="">Nama Kelurahan</option>
                      @foreach ($dataKel as $dataPeg)
                          <option value="{{ $dataPeg->id }}">{{ $dataPeg->nama_kelurahan }}</option>
                      @endforeach
                  </select>
              </div> <br>
              <div class="mb-4">
                <div class="relative">
                    <select name="kecamatan_id" id="kecamatan_id" class="block text-sm font-medium text-gray-700">
                        ...
                        @foreach ($dataKec as $dataPeg)
                            <option value="{{ $dataPeg->id }}">{{ $dataPeg->nama_kecamatan }}</option>
                        @endforeach
                    </select>
                </div> <br>
                <div class="mb-4">
                    <div class="relative">
                        <select name="provinsi_id" id="provinsi_id" class="block text-sm font-medium text-gray-700">
                            ...
                            @foreach ($dataProv as $dataPeg)
                                <option value="{{ $dataPeg->id }}">{{ $dataPeg->nama_provinsi }}</option>
                            @endforeach
                        </select>
                    </div>
          </div>
