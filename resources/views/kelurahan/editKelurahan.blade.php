...
<div class="min-h-full">
    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <form action="{{ route('updateKelurahan', ['id' => $dataKel->id]) }}" method="POST" class="max-w-md mx-auto">
            @csrf
            <div class="mb-4">
                <label for="kode_kel" class="block text-sm font-medium text-gray-700">Kode Kelurahan</label>
                <input type="text" name="kode_kel" id="kode_kel" value="{{ $dataKel->kode_kel }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="nama_kelurahan" class="block text-sm font-medium text-gray-700">Nama Kelurahan</label>
                <input type="text" name="nama_kelurahan" id="nama_kelurahan" value="{{ $dataKel->nama_kelurahan }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <div class="relative">
                    ...
                    <select name="kecamatan_id" id="kecamatan_id" class="block text-sm font-medium text-gray-700">
                        <option value="{{ $dataKel->kecamatan_id }}">{{ $dataKel->kecamatan->nama_kecamatan}}</option>
            ...
            <div class="mb-4 inline-block items-start justify-start">
              ...
              <input type="checkbox" name="active_kel" value="1" id="active_kel" {{ $dataKel->active_kel == 1 ? 'checked' :  '' }} class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
