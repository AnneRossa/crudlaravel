...
<div class="min-h-full">
    <nav class="bg-gray-800" x-data="{ isOpen: false }">
      ...
      <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="/provinsi" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-mediumxs" aria-current="page">Provinsi</a>
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Create Kelurahan Page</h1>
      </div>
    </header>
    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <form action="{{ route('saveKelurahan') }}" method="POST" class="max-w-md mx-auto">
            {{ @csrf_field() }}
            <div class="mb-4">
                <label for="kode_kel" class="block text-sm font-medium text-gray-700">Kode Kelurahan</label>
                <input type="text" name="kode_kel" id="kode_kel" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
                <label for="nama_kelurahan" class="block text-sm font-medium text-gray-700">Nama Kelurahan</label>
                <input type="text" name="nama_kelurahan" id="nama_kelurahan" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            ...
            <div class="mb-4">
              <div class="relative">
                  <select name="kecamatan_id" id="kecamatan_id" class="block text-sm font-medium text-gray-700">
                      ...
                      @foreach ($dataKec as $dataKel)
                          <option value="{{ $dataKel->id }}">{{ $dataKel->nama_kecamatan }}</option>
                      @endforeach
                  </select>
              </div>
          </div>
          <div class="mb-4 inline-block items-start justify-start">
            <label for="active_kel" class="block text-sm font-medium text-gray-700">Active</label>
            <input type="checkbox" name="active_kel" value="1" id="active_kel" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
          </div>
